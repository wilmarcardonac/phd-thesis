...
\only<7>{
\put(0,1.5){Interesting: there is a $3.4\sigma$ tension between direct and inferred }
\put(0,1){determinations of $H_0$. At least two possible reasons.}}
\only<8>{
\put(0,1.5){1. New physics (e.g., modifying assumptions in the concordance}
\put(0,1){model)?}}
...
\only<9>{
\put(0,1.5){2. Issues with statistical analysis (e.g., outlier rejection algorithms,}
...
\begin{frame}{Results: the R11 data set}{Uncertainty of $H_0$ depends on number of HP}
\begin{center}
%\item[]
